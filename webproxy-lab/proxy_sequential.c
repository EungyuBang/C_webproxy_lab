 ...
 * - 1. Basic sequential proxying of GET requests.
 * - 2. Parsing absolute URIs (e.g., http://host:port/path).
 * - 3. Forwarding requests to origin servers.
 * - 4. Relaying server responses back to the client (browser).
 * - 5. Handling required HTTP/1.0 headers (Host, Connection, etc.).
 */
#include "csapp.h"
